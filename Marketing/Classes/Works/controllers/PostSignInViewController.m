...
- (void)creatSignInfoView
{
    ...
    _timeTitleLabel = [ViewTool getLabelWith:CGRectMake(2 * TopSpace, TopSpace, 80, 15) WithTitle:@"签到时间" WithFontSize:10.0f WithTitleColor:[UIColor colorWithWhite:0.6 alpha:1] WithTextAlignment:NSTextAlignmentLeft];
    ...
    _signPlaceLabel = [ViewTool getLabelWith:CGRectMake(_currentTimeLabel.x, line.maxY + TopSpace, 80, 15) WithTitle:@"签到地点" WithFontSize:10.0f WithTitleColor:[UIColor colorWithWhite:0.6 alpha:1] WithTextAlignment:NSTextAlignmentLeft];
    ...
    _currentPlaceBtn.backgroundColor = [UIColor orangeColor];
//    _currentPlaceBtn setImage:[UIImage ] forState:<#(UIControlState)#>
    ...
    lighGrayView.backgroundColor = [UIColor colorWithWhite:0.8 alpha:0.8];
...
//    [UIColor colorWithRed:162 / 255 green:162 / 255 blue:162 / 255 alpha:1];
    _recordTitle = [ViewTool getLabelWith:CGRectMake(2 * TopSpace,2 * TopSpace, 200, 15) WithTitle:@"请填写签到备注" WithFontSize:12.0 WithTitleColor:[UIColor colorWithWhite:0.6 alpha:1] WithTextAlignment:NSTextAlignmentLeft];
...
//    _textView.layer.borderColor = [UIColor colorWithWhite:0.8 alpha:0.8].CGColor;
    ...
    lighGrayView2.backgroundColor = [UIColor colorWithWhite:0.8 alpha:0.8];
...
{
    _companyTitle = [ViewTool getLabelWith:CGRectMake(2 * TopSpace, _recordView.maxY + 2 * TopSpace, 100, 15) WithTitle:@"当前企业" WithFontSize:12.0f WithTitleColor:[UIColor colorWithWhite:0.8 alpha:1] WithTextAlignment:NSTextAlignmentLeft];
