...
//    _noticeConten.backgroundColor = [UIColor redColor];
    ...
    _noticePicBtn = [[UIButton alloc] initWithFrame:CGRectMake(_noticeTitle.x, _noticeConten.maxY + space, [UIView getWidth:30], [UIView getHeight:30])];
    ...
    [_noticePicBtn setImage:[UIImage imageNamed:@"相机"] forState:UIControlStateNormal];
...
//    _showCoverImage.backgroundColor = [UIColor redColor];
    ...
    [_takePicBtn setImage:[UIImage imageNamed:@"相机"] forState:UIControlStateNormal];
...
- (void)drawBottomView
{
    ...
    _addPersonsBtn = [[UIButton alloc] initWithFrame:[UIView getRectWithX:_titleLabel.x Y:_titleLabel.maxY + space width:[UIView getWidth:40] andHeight:[UIView getWidth:40]]];
