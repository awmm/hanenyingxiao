...
- (void)createUI{
    ...
    //员工号码
    UILabel *phoneLabel = [ViewTool getLabelWith:CGRectMake(STARTX, 64 +5, LINEW, labelH) WithTitle:@"员工号码" WithFontSize:14.0f WithTitleColor:grayLineColor WithTextAlignment:NSTextAlignmentLeft];
    ...
    //员工姓名
    UILabel *nameLabel = [ViewTool getLabelWith:CGRectMake(STARTX, _phoneTF.maxY + 10, LINEW, labelH) WithTitle:@"员工姓名" WithFontSize:14.0f WithTitleColor:grayLineColor WithTextAlignment:NSTextAlignmentLeft];
    ...
    //是否短信通知
    UILabel *inviteLabel = [ViewTool getLabelWith:CGRectMake(STARTX, _nameTF.maxY + 10, LINEW, labelH) WithTitle:@"短信通知ta加入企业应用" WithFontSize:15.0f WithTitleColor:[UIColor cyanColor] WithTextAlignment:NSTextAlignmentLeft];
...
//    [self.view addSubview:inviteBtn];
    ...
    explainLabel.textColor = grayLineColor;
    explainLabel.font = [UIFont systemFontOfSize:16.0f];
    explainLabel.numberOfLines = 0;
    [self.view addSubview:explainLabel];
    
    UIButton *referBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, KSCreenH - 40, KSCreenW, 50)];
    referBtn.layer.borderWidth = 0.5;
    referBtn.layer.borderColor = grayLineColor.CGColor;
    referBtn.backgroundColor = grayLineColor;
