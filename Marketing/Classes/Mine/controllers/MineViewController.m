...
- (void)createUI{
    ...
    _nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 40, KSCreenW, 40)];
    _nameLabel.text = @"小花花";
    _nameLabel.textColor = [UIColor redColor];
    _nameLabel.textAlignment = NSTextAlignmentCenter;
    [headerView addSubview:_nameLabel];
    
    _headerBtn = [[UIButton alloc]initWithFrame:CGRectMake((KSCreenW-headerImageW)/2, _nameLabel.maxY + 10, headerImageW, headerImageW)];
    _headerBtn.backgroundColor = [UIColor blueColor];
    ...
    UIImageView *photoImageView = [[UIImageView alloc]initWithFrame:CGRectMake(_headerBtn.maxX - 20, _headerBtn.maxY -20 , 20, 20)];
    photoImageView.image =[UIImage imageNamed:@"相机"];
    [headerView addSubview:photoImageView];
    
    
    _phoneLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, _headerBtn.maxY + 10, KSCreenW, 40)];
