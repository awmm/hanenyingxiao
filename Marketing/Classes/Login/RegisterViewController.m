...
- (void)sumitReg{
        NSLog(@"sumitReg");
//    if (_phoneFld.text == nil | [_phoneFld.text length] == 0 | _checkFld.text == nil | [_checkFld.text length] == 0 | _checkFld2.text == nil | [_checkFld2.text length] == 0 | _checkFld2.text == nil | [_checkFld2.text length] == 0 | _passFld.text == nil | [_passFld.text length] == 0 | _passFld2.text == nil | [_passFld2.text length] == 0) {
...
- (void)textFieldChanged{
    if(_checkFld.text != nil & [_checkFld.text length] != 0 ){
    ...
    if(_checkFld2.text != nil & [_checkFld2.text length] != 0 ){
